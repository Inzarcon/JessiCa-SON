...
from common.components.formatted_qlabel import FormattedQLabel
...
class ComposeProgressBars(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.lbl_loaded = FormattedQLabel("Sprites loaded:", font_size=10, bold=True)
        self.progress_bar_loaded = QProgressBar()
        self._set_color(self.progress_bar_loaded, "#4175c4")

        self.lbl_composed = FormattedQLabel("Sprites composed:", font_size=10, bold=True)
        self.progress_bar_composed = QProgressBar()
        self._set_color(self.progress_bar_composed, "#669ff5")

        layout = QGridLayout()
        self.setLayout(layout)
        layout.addWidget(self.lbl_loaded, 0, 0)
        layout.addWidget(self.progress_bar_loaded, 0, 1)
        layout.addWidget(self.lbl_composed, 1, 0)
        layout.addWidget(self.progress_bar_composed, 1, 1)
